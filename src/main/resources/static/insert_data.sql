INSERT INTO `paymybuddy`.`user`(`email`,`firstname`,`lastname`,`password`)
VALUES ('betty.domain@free.fr','betty','domain','$2a$12$yc2A75xOtp72Yl8sWplcReJs8Ku0zg6Im7U7W35y5eo5xagomBAOa');
