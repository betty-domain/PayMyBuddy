...
public interface IFriendshipService {
     ...
     */
    boolean desactivateFriendship(Integer userId, Integer friendUserId);
     ...
     */
    UserDto addFriend(Integer userId, Integer friendUserId);
     ...
     */
    FriendshipDTO getFriendForUser(Integer userId);
